...
public class SearchByKeywordInName {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            /**
             * This will find 'Dwie egzekucje / Two executions' (GC4MPPR) thanks to the SnowballPorterFilterFactory
             * for the English language and LowerCaseFilterFactory.
             */
            final Query luceneQuery = queryBuilder.keyword()
                    .onField("name")
                    .matching("Execution")
                    .createQuery();
